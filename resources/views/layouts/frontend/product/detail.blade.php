...
@section('title')
    {{$product->name}} | Online Shopping Market
@endsection
            ...
            <div class='row single-product'>
                <div class='col-md-3 sidebar'>
                    <div class="sidebar-module-container">
                        ...
                        @include('layouts.frontend.partial.sidebar_detail')
                                    ...
                                    <div id="owl-single-product">
                                        @foreach($product->images as $image)
                                            ...
                                            <div class="single-product-gallery-item" id="slide{{$image->id}}">
                                                <a data-lightbox="image-{{$image->id}}" data-title="Gallery" href="{{asset('storage/products/'.$image->image)}}">
                                                    <img class="img-responsive" alt="" src="{{asset('assets/frontend/images/blank.gif')}}" data-echo="{{asset('storage/products/'.$image->image)}}" />
                                                </a>
                                            ...
                                            @foreach($product->images as $image)
                                                <div class="item">
                                                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="{{$image->id}}" href="#slide{{$image->id}}">
                                                        <img class="img-responsive" width="85" alt="" src="{{asset('assets/frontend/images/blank.gif')}}" data-echo="{{asset('storage/products/'.$image->image)}}" />
                                                    </a>
                                                </div>
                                            @endforeach
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="stock-container info-container m-t-10">
                                        <div class="row">
                                            ...
                                            @if($product->quantity >0)
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="stock-box">
                                                        <span class="value">({{$product->quantity}}) In Stock</span>
                                                    </div>
                                                </div>
                                                @else
                                                <div class="col-sm-9">
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <button onclick="addToCart({{$product->id}})" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</button>
                                            </div>
