        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    <li class='active'><a href="{{route('category.show',$category->slug)}}" class="">{{$category->name}}</a></li>
                </ul>
            </div>
            <!-- /.breadcrumb-inner -->
        </div>
                                                        ...
                                                        <div class="col col-sm-8 col-lg-8">
                                                            <div class="product-info">
                                                                ...
                                                                <div class="description m-t-10">{!! Str::limit($product->description,200) !!}
                                                                    <a href="{{route('product.detail',$product->slug)}}" class="btn"> More details</a></div>
                                                                <div class="cart clearfix animate-effect">
                                                                    <div class="action">
                                                                        <ul class="list-unstyled">
                                                                            <li class="add-cart-button btn-group">
