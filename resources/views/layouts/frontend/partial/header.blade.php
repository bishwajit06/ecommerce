            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('carts') }}"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
                ...
                <div class="cnt-block">
                    <ul class="list-unstyled list-inline">
                        @guest
                        <li class="nav-item">
                            <a style="color:rgba(255,255,255,0.8);" href="{{ route('login') }}"><i class="icon fa fa-lock"></i>{{ __(' Login') }}</a>
                        </li>
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a style="color:rgba(255,255,255,0.8);" href="{{ route('register') }}"><i class="icon fa fa-check"></i>{{ __(' Register') }}</a>
                            </li>
                        @endif
                        @else
                    ...
                    <div class="search-area">
                        <form action="{{route('search')}}" method="get">
                            <div class="control-group">
                                ...
                                @if(isset($query))
                                    <input class="search-field" value="{{$query}}" name="query"/>
                                @else
                                    <input class="search-field" placeholder="Search here..." name="query"/>
                                 @endif
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                            <div class="items-cart-inner">
                                ...
                                <div class="basket-item-count"><span class="count" id="totalItems">{{App\Cart::totalItems()}}</span></div>
                            ...
                            @foreach(App\Cart::totalCarts() as $cart)
                                <div class="cart-item product-summary">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                            <h3 class="name"><a href="index.php?page-detail">{{$cart->product->name}}</a> x {{$cart->product_quantity}}</h3>
                                            @php
                                                $totalPrice += $cart->product->price * $cart->product_quantity;
                                            @endphp
                                            <div style="float: left; margin-right: 10px;" class="price">{{$cart->product->price * $cart->product_quantity }} BDT</div>
                                ...
                                <div class="pull-right">
                                    <span class="text">Sub Total :</span><span class='price'>{{$totalPrice}}</span>
                                </div>
                                <div>
                                    <div class="clearfix"></div>
                                    <a href="{{route('carts')}}" class="btn btn-upper btn-primary btn-block m-t-20">Cart Details</a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <div>
                                    ...
                                    <a href="{{route('shop')}}" class="btn btn-upper btn-primary btn-block m-t-20">Continue Shopping</a>
                                </div>
                            </li>
